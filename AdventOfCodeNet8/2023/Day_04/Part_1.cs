...
namespace AdventOfCodeNet8._2023.Day_04
{
  internal class Part_1 : Days
  {
    ...
    We really need to come up with a better naming scheme. Tell you what: 
    if you can help me with something quick, I'll let you borrow my boat and you can go visit the 
    ...
    has two lists of numbers separated by a vertical bar (|): 
    ...
    */
    ...
    public override string Execute()
    {
      ...
      foreach (var line in Lines)
      {
        ...
        var wins = from mn in myNumbers where winningNumbers.Contains(mn) select mn;

        int score = 0;
        if (wins.Count() > 0)
        {
          score = (int)Math.Pow(2, wins.Count() - 1);
        }
        totalScore += score;
