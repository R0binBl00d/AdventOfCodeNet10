...
namespace AdventOfCodeNet8._2015.Day_25
{
  internal class Part_1 : Days
  {
    ...
    "that's not even all of the first few numbers; for example, you're missing the one at 7,1 that would come before 6,2. 
