namespace AdventOfCodeNet9._2015.Day_23
{
  internal class Part_1_2015_Day_23 : Days
  {
    ...
    unknown benefactor.
    It comes with instructions and an example program, but the computer itself
    ...
    The registers are named a and b, can hold any non-negative integer, and begin
    with a value of 0.
