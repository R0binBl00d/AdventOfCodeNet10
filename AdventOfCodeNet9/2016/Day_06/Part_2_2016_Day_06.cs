namespace AdventOfCodeNet10._2016.Day_06
{
  internal class Part_2_2016_Day_06 : Days
  {
    ...
    data, but for each character,
    the character they actually want to send is slightly less likely than the
    others.
    ...
    Repeating this process for the remaining characters produces the original
    message, advent.
