...
namespace AdventOfCodeNet10._2016.Day_05
{
  internal class Part_2_2016_Day_05 : Days
  {
    ...
    slightly more inspired security mechanism.
    Clearly unimpressed by the last version (in what movie is the password
    decrypted in order?!),
    ...
    the sixth character represents the position (0-7), and the seventh character is
