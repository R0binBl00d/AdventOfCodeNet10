namespace AdventOfCodeNet10._2015.Day_22
{
  internal class Part_1_2015_Day_22 : Days
  {
    ...
    */
    /// </summary>
    /// <returns>
    /// 854 answer is too low !!
    /// 947 answer is too low !!
    /// 953 -> That's the right answer! Your puzzle answer was 953.
    /// 1295 answer is too high !!
    /// </returns>
...
#pragma warning disable CS8602 // Dereference of a possibly null reference.
      // me is always a wizard, so Spells is never null, compiler just can't figure it out
...
/*
https://medium.com/@ghaiklor/advent-of-code-2015-explanation-aa9932db6d6f#b5cf
https://github.com/ghaiklor/advent-of-code-2015/blob/master/day-22/part-1/solution.js
...
function playAllGames(me, boss) {
  for (let i = 0; i < me.spells.length; i++) {
    ...
    if (newMe.hp > 0 && newBoss.hp > 0 && newMe.spent < cheapestSpent) playAllGames(newMe, newBoss);
  }
}
